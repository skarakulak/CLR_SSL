...
#################
# set a job name
#SBATCH --job-name=CITY_v72
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v72.out
#################
# a file for errors from the job
#SBATCH --error=error_v72.err
#################
...
srun python3 ../train16.py -e 130  -v v72_r18 -w wv61_r18_best -x wv72_r18 -o sgd -l 0.000003 -d 0.00001 -n 2000 -c .002 -S 0 -W 6 -D 0.33 -R 1 -E 1 -b .05 -i .5 -C prince
srun python3 ../train16.py -e 3000 -v v72_r18 -w wv72_r18      -x wv72_r18 -o sgd -l 0.000001 -d 0.00001 -n 2000 -c .002 -S 0 -W 6 -D 0.33 -R 1 -E 1 -b .05 -i .5 -C prince
