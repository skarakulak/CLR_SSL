...
#################
# set a job name
#SBATCH --job-name=CITY_v64
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v64.out
#################
# a file for errors from the job
#SBATCH --error=error_v64.err
#################
...
srun python3 ../train16.py -e 130  -v v64_r18 -w wv61_r18_best -x wv64_r18 -o sgd -l 0.00003 -d 0.00001 -n 2000 -c .002 -S 0 -W 6 -D 0.33 -R 1 -E 1 -b 2 -i 20 -C prince
srun python3 ../train16.py -e 3000 -v v64_r18 -w wv64_r18      -x wv64_r18 -o sgd -l 0.00001 -d 0.00001 -n 2000 -c .002 -S 0 -W 6 -D 0.33 -R 1 -E 1 -b 2 -i 20 -C prince
