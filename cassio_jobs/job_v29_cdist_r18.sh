...
#################
# set a job name
#SBATCH --job-name=V29_r18
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v29_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v29_r18.err
#################
...
srun python3 ../train11.py -e 300  -v v29_r18 -w wv29_r18_best -x wv29_r18 -o adam -l 0.001  -N 4000 -f 0 -k 0.0001 -g 0 -S -
srun python3 ../train11.py -e 3000 -v v29_r18 -w wv29_r18      -x wv29_r18 -o adam -l 0.0003 -N 4000 -f 0 -k 0.0001 -g 0 -S 0
