...
#################
# set a job name
#SBATCH --job-name=V33_r18
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v33_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v33_r18.err
#################
...
srun python3 ../train11.py -e 300  -v v33_r18 -w wv33_r18 -x wv33_r18 -o adam -l 0.001  -N 3000 -f 0 -k 0.005 -S 1 -g 0
srun python3 ../train11.py -e 3000 -v v33_r18 -w wv33_r18 -x wv33_r18 -o adam -l 0.0003 -N 3000 -f 0 -k 0.005 -S 1 -g 0
