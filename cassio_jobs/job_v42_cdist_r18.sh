...
#################
# set a job name
#SBATCH --job-name=v42_r18
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v42_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v42_r18.err
#################
...
srun python3 ../train15.py -e 300  -v v42_r18 -w wv42_r18 -x wv42_r18 -o adam -l 0.001  -n 1000 -c .0003 -S 0 -W 5
srun python3 ../train15.py -e 3000 -v v42_r18 -w wv42_r18 -x wv42_r18 -o adam -l 0.0003 -n 1000 -c .0003 -S 0 -W 5
