...
srun python3 ../train2.py -s 0 -e 300  -a resnet34 -v v2_r34_c -w wv0_r34_best -x wv2_r34 -o adam -l 0.003 -d 0.3 -m 2000 -c 0 -p 2000 -n 4 -C cassio -u sk7685
srun python3 ../train2.py -s 0 -e 3000 -a resnet34 -v v2_r34_c -w wv2_r34      -x wv2_r34 -o adam -l 0.001 -d 0.3 -m 2000 -c 0 -p 2000 -n 4 -C cassio -u sk7685
