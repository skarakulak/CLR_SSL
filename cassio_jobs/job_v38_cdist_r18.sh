...
#################
# set a job name
#SBATCH --job-name=v38_r18
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v38_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v38_r18.err
#################
...
srun python3 ../train15.py -e 300  -v v38_r18 -w wv38_r18 -x wv38_r18 -o adam -l 0.001  -n 5000 -c 1.5 -S 1 -W 5
srun python3 ../train15.py -e 3000 -v v38_r18 -w wv38_r18 -x wv38_r18 -o adam -l 0.0003 -n 5000 -c 1.5 -S 1 -W 5
