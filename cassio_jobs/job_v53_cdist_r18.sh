...
#################
# set a job name
#SBATCH --job-name=v53_r18
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v53_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v53_r18.err
#################
...
srun python3 ../train15.py -e 300  -v v53_r18 -w wv51_r18 -x wv53_r18 -o adam -l 0.0001 -d 0.0003 -n 2000 -c .003 -S 0 -W 5 -D 0.2
srun python3 ../train15.py -e 3000 -v v53_r18 -w wv53_r18 -x wv53_r18 -o adam -l 0.00003 -d 0.0003 -n 2000 -c .003 -S 0 -W 5 -D 0.2
