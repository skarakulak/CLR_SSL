...
#################
# set a job name
#SBATCH --job-name=V15_r18
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v15_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v15_r18.err
#################
...
srun python3 ../train9.py -s 0 -e 300  -a resnet18 -v v15_r18 -w wv15_r18 -x wv15_r18 -o adam -l 0.003 -T 0.2 -d 0.3 -c 45. -p 2000 -n 4 -N 2000 -C cassio -u sk7685
srun python3 ../train9.py -s 0 -e 3000 -a resnet18 -v v15_r18 -w wv15_r18 -x wv15_r18 -o adam -l 0.001 -T 0.2 -d 0.3 -c 45. -p 2000 -n 4 -N 2000 -C cassio -u sk7685
