...
#################
# set a job name
#SBATCH --job-name=v46_r18
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v46_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v46_r18.err
#################
...
srun python3 ../train15.py -e 300  -v v46_r18 -w wv37_r18 -x wv46_r18 -o sgd -l 0.00001 -n 2000 -c 3 -S 1 -W 6
srun python3 ../train15.py -e 3000 -v v46_r18 -w wv46_r18 -x wv46_r18 -o sgd -l 0.000003 -n 2000 -c 3 -S 1 -W 6
