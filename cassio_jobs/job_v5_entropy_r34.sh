...
#################
# set a job name
#SBATCH --job-name=V5_r34_c
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v5_r34.out
#################
# a file for errors from the job
#SBATCH --error=error_v5_r34.err
#################
...
srun python3 ../train.py -s 0 -e 300  -a resnet34 -v v5_r34_c -w wv0_r34_best -x wv5_r34 -o adam -l 0.003 -d 0.3 -m 0 -c 1. -p 2000 -n 4 -C cassio -u sk7685
srun python3 ../train.py -s 0 -e 3000 -a resnet34 -v v5_r34_c -w wv5_r34      -x wv5_r34 -o adam -l 0.001 -d 0.3 -m 0 -c 1. -p 2000 -n 4 -C cassio -u sk7685
