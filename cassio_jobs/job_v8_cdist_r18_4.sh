...
#################
# set a job name
#SBATCH --job-name=4V8_r18_c
#################
# a file for job output, you can check job progress
#SBATCH --output=4output_v8_r18.out
#################
# a file for errors from the job
#SBATCH --error=4error_v8_r18.err
#################
...
srun python3 ../train7.py -s 0 -e 300  -a resnet18 -v 4v8_r18_c -w w4v8_r18_best -x w4v8_r18 -o adam -l 0.003 -d 0.3 -c 10. -p 2000 -n 4 -C cassio -u sk7685
srun python3 ../train7.py -s 0 -e 3000 -a resnet18 -v 4v8_r18_c -w w4v8_r18      -x w4v8_r18 -o adam -l 0.001 -d 0.3 -c 10. -p 2000 -n 4 -C cassio -u sk7685
