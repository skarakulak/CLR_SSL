...
#################
# set a job name
#SBATCH --job-name=V14_r18
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v14_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v14_r18.err
#################
...
srun python3 ../train9.py -s 0 -e 300  -a resnet18 -v v14_r18 -w wv11_r18_best -x wv14_r18 -o adam -l 0.003 -D 0.30 -d 0.3 -c 1. -p 2000 -n 4 -N 2000 -C cassio -u sk7685
srun python3 ../train9.py -s 0 -e 3000 -a resnet18 -v v14_r18 -w wv14_r18      -x wv14_r18 -o adam -l 0.001 -D 0.30 -d 0.3 -c 1. -p 2000 -n 4 -N 2000 -C cassio -u sk7685
