...
#################
# set a job name
#SBATCH --job-name=v79_r18
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v79_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v79_r18.err
#################
...
srun python3 ../train16.py -e 130  -v v79_r18 -w wv61_r18 -x wv79_r18 -o sgd -l 0.000005  -d 0.00001 -n 2000 -c .002 -S 0 -W 6 -D 0.33 -R 1 -E 1 -b 0.8 -t .66 -i 5 -Z 2
srun python3 ../train16.py -e 3000 -v v79_r18 -w wv79_r18 -x wv79_r18 -o sgd -l 0.000002 -d 0.00001 -n 2000 -c .002 -S 0 -W 6 -D 0.33 -R 1 -E 1 -b 0.8 -t .66 -i 5 
