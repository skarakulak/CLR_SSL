...
srun python3 ../train.py -s 0 -e 300 -a resnet34 -v v0_c34 -w wv0_r34 -x wv0_r34 -o adam -l 0.003 -d 0.3 -m 0 -c 0 -p 2000 -n 4 -C cassio -u sk7685
srun python3 ../train.py -s 0 -e 3000 -a resnet34 -v v0_c34 -w wv0_r34 -x wv0_r34 -o adam -l 0.001 -d 0.3 -m 0 -c 0 -p 2000 -n 4 -C cassio -u sk7685
