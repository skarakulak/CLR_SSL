...
#################
# set a job name
#SBATCH --job-name=v59_r18
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v59_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v59_r18.err
#################
...
srun python3 ../train15.py -e 130  -v v59_r18 -w wv58_r18_best -x wv59_r18 -o sgd -l 0.00003  -d 0.0001 -n 2000 -c .002 -S 0 -W 6 -D 0.33 -R 1
srun python3 ../train15.py -e 3000 -v v59_r18 -w wv59_r18      -x wv59_r18 -o sgd -l 0.00001 -d 0.0001 -n 2000 -c .002 -S 0 -W 6 -D 0.33 -R 1
