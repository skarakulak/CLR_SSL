...
#################
# set a job name
#SBATCH --job-name=V36_r18
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v36_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v36_r18.err
#################
...
srun python3 ../train14.py -e 300  -v v36_r18 -w wv36_r18 -x wv36_r18 -o adam -l 0.001  -N 2000 -k .005 -g 1 -f 0.1 -S 1
srun python3 ../train14.py -e 3000 -v v36_r18 -w wv36_r18 -x wv36_r18 -o adam -l 0.0003 -N 2000 -k .005 -g 1 -f 0.1 -S 1
