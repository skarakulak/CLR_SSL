...
#################
# set a job name
#SBATCH --job-name=V34_r18
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v34_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v34_r18.err
#################
...
srun python3 ../train11.py -e 300  -v v34_r18 -w wv34_r18 -x wv34_r18 -o adam -l 0.001  -N 8000 -f 0 -k 0.001 -S 0 -g 0
srun python3 ../train11.py -e 3000 -v v34_r18 -w wv34_r18 -x wv34_r18 -o adam -l 0.0003 -N 8000 -f 0 -k 0.001 -S 0 -g 0
