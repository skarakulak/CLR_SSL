...
srun python3 ../train5.py -s 0 -e 300  -a resnet18 -v v8_r18_c -w wv0_best -x wv8_r18 -o adam -l 0.003 -d 0.3 -c .01 -p 2000 -n 4 -C cassio -u sk7685
srun python3 ../train5.py -s 0 -e 3000 -a resnet18 -v v8_r18_c -w wv8_r18  -x wv8_r18 -o adam -l 0.001 -d 0.3 -c .01 -p 2000 -n 4 -C cassio -u sk7685
