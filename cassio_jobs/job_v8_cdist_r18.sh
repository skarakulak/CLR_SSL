...
#################
# set a job name
#SBATCH --job-name=V8_r18_c
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v8_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v8_r18.err
#################
...
srun python3 ../train9.py -s 0 -e 30  -a resnet18 -v v8_r18_c -w wv8_r18_best -x wv8_r18 -o sgd  -l 0.000001  -d 0.3 -c 20. -p 2000 -n 4 -C cassio -u sk7685
srun python3 ../train9.py -s 0 -e 3000 -a resnet18 -v v8_r18_c -w wv8_r18_best -x wv8_r18 -o sgd -l 0.0000003 -d 0.3 -c 20. -p 2000 -n 4 -C cassio -u sk7685
