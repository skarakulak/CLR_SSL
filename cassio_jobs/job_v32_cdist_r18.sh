...
srun python3 ../train11.py -e 300  -v v32_r18 -w wv32_r18 -x wv32_r18 -o adam -l 0.001  -N 8000 -f 0 -k 1
srun python3 ../train11.py -e 3000 -v v32_r18 -w wv32_r18 -x wv32_r18 -o adam -l 0.0003 -N 8000 -f 0 -k 1
