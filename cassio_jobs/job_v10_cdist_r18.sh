...
#################
# set a job name
#SBATCH --job-name=V10_r18
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v10_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v10_r18.err
#################
...
srun python3 ../train8.py -s 0 -e 300  -a resnet18 -v v10_r18 -w wv10_r18 -x wv10_r18 -o adam -l 0.003 -d 0.3 -c 30. -p 2000 -n 4 -N 2000 -C cassio -u sk7685
srun python3 ../train8.py -s 0 -e 3000 -a resnet18 -v v10_r18 -w wv10_r18 -x wv10_r18 -o adam -l 0.001 -d 0.3 -c 30. -p 2000 -n 4 -N 2000 -C cassio -u sk7685
