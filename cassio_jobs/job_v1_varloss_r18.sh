...
#################
# set a job name
#SBATCH --job-name=V1_r18_c
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v1_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v1_r18.err
#################
...
srun python3 ../train.py -s 0 -e 300  -a resnet18 -v v1_r18_c -w wv0_best -x wv1_r18 -o adam -l 0.003 -d 0.3 -m 1000 -c 0 -p 2000 -n 4 -C cassio -u sk7685
srun python3 ../train.py -s 0 -e 3000 -a resnet18 -v v1_r18_c -w wv1_r18  -x wv1_r18 -o adam -l 0.001 -d 0.3 -m 1000 -c 0 -p 2000 -n 4 -C cassio -u sk7685
