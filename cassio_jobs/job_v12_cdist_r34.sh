...
#################
# set a job name
#SBATCH --job-name=V12_r34
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v12_r34.out
#################
# a file for errors from the job
#SBATCH --error=error_v12_r34.err
#################
...
srun python3 ../train9.py -s 0 -e 300  -a resnet34 -v v12_r34 -w wv11_r34_best -x wv12_r34 -o adam -l 0.003 -d 0.3 -c 10. -p 2000 -n 4 -N 2000 -C cassio -u sk7685
srun python3 ../train9.py -s 0 -e 3000 -a resnet34 -v v12_r34 -w wv12_r34      -x wv12_r34 -o adam -l 0.001 -d 0.3 -c 10. -p 2000 -n 4 -N 2000 -C cassio -u sk7685
