...
#################
# set a job name
#SBATCH --job-name=V31_r18
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v31_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v31_r18.err
#################
...
srun python3 ../train11.py -e 300  -v v31_r18 -w wv31_r18 -x wv31_r18 -o adam -l 0.001  -N 2000 -f 0 -k 0.001 -g 0 -S 0
srun python3 ../train11.py -e 3000 -v v31_r18 -w wv31_r18 -x wv31_r18 -o adam -l 0.0003 -N 2000 -f 0 -k 0.001 -g 0 -S 0
