...
#################
# set a job name
#SBATCH --job-name=v45_r18
#################
# a file for job output, you can check job progress
#SBATCH --output=output_v45_r18.out
#################
# a file for errors from the job
#SBATCH --error=error_v45_r18.err
#################
...
srun python3 ../train15.py -e 300  -v v45_r18 -w wv37_r18 -x wv45_r18 -o sgd -l 0.000003 -n 2000 -c 1 -S 1 -W 6
srun python3 ../train15.py -e 3000 -v v45_r18 -w wv45_r18 -x wv45_r18 -o sgd -l 0.000001 -n 2000 -c 1 -S 1 -W 6
